...
import Controller.TrainingServlet;
 ...
 * @author quangminh
 */
@WebServlet(name = "TrainingSchedulePlayer", urlPatterns = {"/TrainingSchedulePlayer"})
public class TrainingSchedulePlayer extends HttpServlet {
    ...
    protected void processRequest(
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TrainingSchedulePlayer</title>");
            out.println("</head>");
            out.println("<body>");
    ...
    public void ListTraining(
        ...
        try {
            ...
            response.sendRedirect("PLAYER/trainingSchedule.jsp");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
