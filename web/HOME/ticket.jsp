        ...
        <div class="card my-4 p-3 d-flex flex-column">
            <c:forEach items="${matchSchedules}" var="match" varStatus="status">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    ">
                        <fmt:formatDate value="${match.getMatchDate()}"
                                        pattern="dd-MMM-yyyy"/>
                    </p>
                    <div class="d-flex flex-column gap-2">
                        <div class="d-flex align-items-center gap-3">
                            <p class="mb-0"
                               style="font-size: 20px; line-height: 21px;font-weight: 700;color: #001838;">${match.awayTeamName}</p>
                            <h4 class="mb-0">VS</h4>
                            <p class="mb-0"
                               style="font-size: 20px; line-height: 21px;font-weight: 700;color: #001838;">${match.homeTeamName}</p>
                        </div>
                        <div class="text-center">
                            <p style="font-size: 17px; line-height: 21px;font-weight: 700;color: #001838;">
                                Location: ${ match.location }</p>
                        </div>
                    </div>
                    <div>
