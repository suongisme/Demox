...
<html lang="en">
    ...
    <div id="playArea">
        <!-- T?o 11 c?u th? -->
        <div class="player" id="player1" data-position="GK" style="background-image: url('IMAGE/HOME/5-bellingham-0410085953.jpg');"><p>Ronaldo</p></div>


        <div class="player" id="player2" data-position="RB"><p>james</p></div>
        <div class="player" id="player3" data-position="LCB"><p>Ramos</p></div>
        <div class="player" id="player4" data-position="RCB"><p>Pepe</p></div>
        <div class="player" id="player5" data-position="LB"><p>marcelo</p></div>
        <div class="player" id="player6" data-position="CDM"><p>Kiera</p></div>
        <div class="player" id="player7" data-position="CAM"><p>Kaka</p></div>
        <div class="player" id="player8" data-position="RM"><p>H.son</p></div>
        <div class="player" id="player9" data-position="LM"><p>Messi</p></div>
        <div class="player" id="player10" data-position="CM"><p>Pirlo</p></div>
        <div class="player" id="player11" data-position="ST"><p>Balloteli</p></div>
        <div class="player" id="player12" data-position="ST"><p>Torres</p></div>
        <div class="player" id="player13" data-position="ST"><p>Tien linh</p></div>
        <div class="player" id="player14" data-position="CAM"><p>Ronaldinho</p></div>
